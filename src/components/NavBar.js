  ...
  return (
    <Router>
      <Navbar expand="md" className={scrolled ? "scrolled" : ""}>
        <Container>
          <Navbar.Brand href="https://durontoalim.github.io/abdulalim-react-app">
            <h2 className="text-white">Alim</h2>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <span className="navbar-text">
              <div className="social-icon">
                <a href="https://www.linkedin.com/in/abdulalim-swe/"><img src={navIcon1} alt="" /></a>
                <a href="https://web.facebook.com/abdulalim.swe"><img src={navIcon2} alt="" /></a>
                <a href="https://www.instagram.com/durontoo_alim/"><img src={navIcon3} alt="" /></a>
              </div>
              <HashLink to='#connect'>
